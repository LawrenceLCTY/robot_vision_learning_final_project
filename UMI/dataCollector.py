...
def collect_data(env: FinalEnv, total_trajectory_num=5, folder_path="./data/"):
    ...
    while trajectory_num < total_trajectory_num:
        ...
        while env.local_total_timesteps < env.local_max_steps:
            ...
            has_box, action_left, action_right, phase = solution.act(env, env.local_total_timesteps)
            if not has_box:
                break
